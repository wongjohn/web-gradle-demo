...
//        install(new JpaPersistModule("domain").properties(mySqlProperties()));
    ...
    public Properties oracleProperties() {
        ...
        properties.put("hibernate.connection.username", "john");
        properties.put("hibernate.connection.password", "john");
...
//        properties.put("hibernate.hbm2ddl.auto", "create");
    ...
    public Properties mySqlProperties() {
        ...
        properties.put("hibernate.connection.url", "jdbc:mysql://localhost:3306/sharebookmark?useUnicode=true&amp;characterEncoding=UTF-8");
